// app/dashboard-notulis/layout.tsx
"use client";
...
export default function NotulisDashboardLayout({
  children,
}: {
  children: React.ReactNode;
}) {
  const [isCollapsed, setIsCollapsed] = useState(false); // Notulis might prefer expanded by default
    ...
    <div className="h-screen flex bg-gray-50 font-sans overflow-hidden">
      ...
      >
        ...
        <button
          ...
          className="absolute -right-3 top-20 z-10 bg-amber-200 border-4 border-indigo-950 rounded-full p-1 shadow-md hover:shadow-lg transition"
        >
          {isCollapsed ? (
