...
export const semanticToClassName: Record<string, string> = {
  ...
  // Aliases for HeroUI compatibility
  primary: "bg-sky-100/60 text-sky-800 border border-sky-300/20",
  default: "bg-slate-100/60 text-slate-600 border border-slate-300/40",
  danger: "bg-red-100/60 text-red-800 border border-red-300/30",
};
