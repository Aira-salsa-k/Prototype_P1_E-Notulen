...
export const semanticToClassName: Record<string, string> = {
  info: "bg-sky-100 text-sky-800 border border-sky-300/40",
  secondary: "bg-purple-100 text-purple-800 border border-purple-300/40",
  success: "bg-emerald-100 text-emerald-800 border border-emerald-300/40",
  ...
  teal: "bg-teal-100 text-teal-800 border border-teal-300/40",
  cyan: "bg-cyan-100 text-cyan-800 border border-cyan-400/40",
  indigo: "bg-indigo-100 text-indigo-800 border border-indigo-300/40",
  lime: "bg-lime-100 text-lime-800 border border-lime-500/40",

  // Aliases for HeroUI compatibility
  primary: "bg-sky-200/70 text-sky-800 border border-sky-300/40",
  default: "bg-slate-200 text-slate-600 border border-slate-300/40",
  danger: "bg-red-200 text-red-800 border border-red-300/40",
};
